...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  Widget build(BuildContext context) {
    return OnBoardingScreen(
      ...
      pages: [
        OnBoardingModel(
          image: Image.asset("assets/images/Farmers-market-amico.png"),
          title: "Business Chat",
          body:
        ...
        OnBoardingModel(
          image: Image.asset("assets/images/Farmers-market-bro.png"),
        ...
        OnBoardingModel(
          image: Image.asset("assets/images/Farmers-market-cuate.png"),
        ...
        OnBoardingModel(
          image: Column(
            children: [
              Image.asset("assets/images/Farmers-market-pana.png"),
              SizedBox(
                height: 20,
              ),
              ElevatedButton(
